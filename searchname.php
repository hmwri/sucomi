...
<div id="contens">
    ...
    <div id='searchresult'>
      ...
      <div class="info">
        ...
        <a href="inputsearch.html" style="text-decoration:none"class="button5">再探索</a>
      </div>
    ...
    $base = 0;
    $keyword=$_GET['search'];
    $url="https://maps.googleapis.com/maps/api/place/textsearch/json?type=supermarket&language=ja&query=".$keyword."&key=AIzaSyDlrZJfOn1y9u0pZBk0txctk9-m13XDZdI";
    ...
    if(count($arr['results'])==0){
        echo "<div class='title'>条件に会うスーパーがありません。条件を変えてください</div>";
    }
    ...
    echo "直近１時間の情報はありません";
        ...
        echo '</div><a href="details.php?id='.$placeid.'&keyword='.$keyword.'"><button type="button" class="button4">詳細</button></a>';
